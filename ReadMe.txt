...
TODO:
1. Написать метод avg(), который возвращает среднее ариметическое элементов дерева;
2. Написать метод erase(), который удаляет заданное значение из дерева;
3. Обспечить вызов методов из функции main() без передачи в них корня дерева;
